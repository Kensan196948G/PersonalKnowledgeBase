...
describe('Notes API', () => {
  ...
  describe('GET /api/notes', () => {
    ...
    it('should return 500 on database error', async () => {
      mockPrismaClient.note.findMany = jest.fn().mockRejectedValue(new Error('DB error'))
  ...
  describe('POST /api/notes', () => {
    ...
    it('should create note with folder ID', async () => {
      ...
      mockPrismaClient.note.create = jest.fn().mockResolvedValue(noteWithFolder)
    ...
    it('should return 500 on database error', async () => {
      mockPrismaClient.note.create = jest.fn().mockRejectedValue(new Error('DB error'))
  ...
  describe('GET /api/notes/:id', () => {
    it('should return a specific note', async () => {
      ...
      mockPrismaClient.note.findUnique = jest.fn().mockResolvedValue(noteWithDetails)
    ...
    it('should return 500 on database error', async () => {
      mockPrismaClient.note.findUnique = jest.fn().mockRejectedValue(new Error('DB error'))
  ...
  describe('PUT /api/notes/:id', () => {
    ...
    it('should return 500 on database error', async () => {
      mockPrismaClient.note.update = jest.fn().mockRejectedValue(new Error('DB error'))
  ...
  describe('DELETE /api/notes/:id', () => {
    ...
    it('should return 500 on database error', async () => {
      mockPrismaClient.note.delete = jest.fn().mockRejectedValue(new Error('Record not found'))
