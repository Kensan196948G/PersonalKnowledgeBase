...
import {
  ...
  syncNoteLinks,
  extractKeywords,
} from "../../src/backend/utils/linkParser.js";
...
describe("Link Parser Utility", () => {
  ...
  describe("extractKeywords", () => {
    it("should extract keywords from text", () => {
      const text =
        "This is a test document about JavaScript and TypeScript programming.";
...
describe("Note Links Database Operations", () => {
  ...
  describe("syncNoteLinks", () => {
    ...
    it("should sync links when note is saved", async () => {
      const content =
        "This note references [[Test Note 2]] and [[Test Note 3]].";
