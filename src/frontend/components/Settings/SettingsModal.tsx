      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="px-6 py-4 space-y-6">
            {/* アプリ情報 */}
            <section>
              <h3 className="text-lg font-medium text-gray-900 mb-3">アプリケーション情報</h3>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <div className="font-medium">全ノートをエクスポート</div>
                        <div className="text-xs text-blue-600">形式を選択してバックアップ</div>
                      </div>
                    </div>
                    <svg
                  ...
                  {isExportMenuOpen && (
                    <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg z-10 overflow-hidden">
                      ...
                      >
                        ...
                        <div>
                          <div className="font-medium text-gray-900">JSON形式</div>
                          <div className="text-xs text-gray-600">全データを構造化形式で保存</div>
                        </div>
                      </button>
                      <button
                      ...
                      >
                        <span className="text-2xl">📄</span>
                        <div>
                          <div className="font-medium text-gray-900">Markdown (ZIP)</div>
                          <div className="text-xs text-gray-600">各ノートを.mdファイルとして保存</div>
                        </div>
                      </button>
                      <button
                      ...
                      >
                        <span className="text-2xl">🌐</span>
                        <div>
                          <div className="font-medium text-gray-900">HTML (ZIP)</div>
                          <div className="text-xs text-gray-600">各ノートをHTMLファイルとして保存</div>
                        </div>
                      </button>
                    </div>
                  )}
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  <div className="text-sm text-gray-600">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-xs">
                      ...
                      <li>個別ノートのエクスポートは各ノートの「エクスポート」ボタンから</li>
            ...
            {/* OneNoteインポート */}
            <section>
              <h3 className="text-lg font-medium text-gray-900 mb-3">OneNoteインポート</h3>
              <div className="space-y-3">
                <button
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      <div className="font-medium">OneNoteファイルをインポート</div>
                      <div className="text-xs text-purple-600">HTMLファイルからノートを作成</div>
                    </div>
                  </div>
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="p-3 bg-blue-50 rounded text-sm text-blue-800">
                  ...
                  <ol className="text-xs space-y-1 list-decimal list-inside">
                    <li>OneNoteで「ファイル」→「エクスポート」→「Webページ (.html)」</li>
                    <li>エクスポートしたHTMLファイルを上のボタンからアップロード</li>
            ...
            {/* キーボードショートカット */}
            <section>
              <h3 className="text-lg font-medium text-gray-900 mb-3">キーボードショートカット</h3>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between py-2 border-b border-gray-100">
                  <span className="text-gray-600">検索</span>
                  <kbd className="px-2 py-1 bg-gray-100 rounded text-xs font-mono">Ctrl/Cmd + K</kbd>
                </div>
                <div className="flex justify-between py-2 border-b border-gray-100">
                  <span className="text-gray-600">サイドバー切り替え</span>
                  <kbd className="px-2 py-1 bg-gray-100 rounded text-xs font-mono">Ctrl/Cmd + \</kbd>
                </div>
                <div className="flex justify-between py-2 border-b border-gray-100">
                  <span className="text-gray-600">太字</span>
                  <kbd className="px-2 py-1 bg-gray-100 rounded text-xs font-mono">Ctrl/Cmd + B</kbd>
                </div>
                <div className="flex justify-between py-2">
                  <span className="text-gray-600">斜体</span>
                  <kbd className="px-2 py-1 bg-gray-100 rounded text-xs font-mono">Ctrl/Cmd + I</kbd>
                </div>
              </div>
            </section>
          </div>
